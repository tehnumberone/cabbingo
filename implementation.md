...
- [x] The picker also lists images boards already link to (wiki URLs, repo assets like `./assets/x.png`); unused links never appear, and the admin page still lists uploads only (`a1258ff`)
