...
- [x] Admin page `/admin/users`: every account with email, claimed names and bingos owned; grant or remove admin, and delete an account by typing its username (not your own, and not while it still owns bingos) (`ffab161`)
